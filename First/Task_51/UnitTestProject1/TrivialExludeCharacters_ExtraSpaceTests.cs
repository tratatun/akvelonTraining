...
{
    [TestClass]
    public class TrivialExludeCharacters_ExtraSpaceTests
    {
        [TestMethod]
        public void TestEmptyInput()
        {
            ...
            string result = Program.TrivialExludeCharacters_ExtraSpace(s1, s2);
        ...
        public void TestNullInput()
        {
            ...
            try
            {
                Program.TrivialExludeCharacters_ExtraSpace(s1, s2);
            }
            catch (Exception e)
            {
                err = e.Message;
