...
namespace UnitTestProject1
{
    ...
    public class TestNotSorted
    {
        ...
        public void TestFileStreamEmpty()
        {
            ...
            try
            {
                using (MemoryStream file = new MemoryStream(Encoding.UTF8.GetBytes(data)))
                {
                    ...
                    string res = CsvDuplicateReader.GetDuplicates(sr, "column1");
                }
            }
            catch (Exception e)
            {
        ...
        public void TestFileStream()
        {
            ...
            {
                StreamReader sr = new StreamReader(file);
                result = CsvDuplicateReader.GetDuplicates(sr, "column1");
            }
        ...
        public void TestFileStreamColumn2()
        {
            ...
            {
                StreamReader sr = new StreamReader(file);
                result = CsvDuplicateReader.GetDuplicates(sr, "column2");
            }
        ...
        public void TestWrongColumnName()
        {
            ...
            try
            {
                ...
                {
                    StreamReader sr = new StreamReader(file);
                    string res = CsvDuplicateReader.GetDuplicates(sr, "column555");
                }
            }
            catch (Exception e)
            {
